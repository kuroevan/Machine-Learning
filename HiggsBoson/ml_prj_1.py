# -*- coding: utf-8 -*-
"""
Created on Sat Dec  1 12:45:09 2018
...
if __name__ == '__main__':
    ...
    print("Confusion Matrix: ", confusion_matrix(ids_test, y_pred)) 

    print("Report: ", classification_report(ids_test, y_pred)) 
      
    print ("Accuracy: ", accuracy_score(ids_test, y_pred)*100) 